...
repo **no es solo Azure**: ya tienes experiencia real en AWS y GCP (MercadoLibre)
...
│   └── 14-ia-infraestructura-mlops/            # opcional: servir/operar modelos de IA, con y sin Kubernetes
...
1. **Elige un tema** de `temas/` (sigue el orden sugerido en `00-diagnostico/roadmap.md`,
   o el que te interese repasar).
2. **Lee** el `README.md` de ese tema: tiene objetivos, subtemas y enlaces oficiales.
3. **Pídeme un examen** de ese tema (ver `examenes/README.md` para el formato).
...
No hace falta pedirme permiso para arrancar: dime "dame un examen de Bicep nivel
intermedio" o "explícame Private Endpoints" y seguimos desde ahí.
